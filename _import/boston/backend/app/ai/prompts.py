...
CLASSIFICATION_PROMPT = """You are a civic-affairs classification assistant for Boston Civic Radar.
...
SUMMARY_PROMPT = """You are drafting a plain-English document summary for Boston Civic Radar,
...
minutes, for Boston Civic Radar. This is about *outcomes* (what was decided), not what was proposed --
...
for Boston Civic Radar. Skip non-substantive entries (call to order, roll call, pledge, adjournment,
